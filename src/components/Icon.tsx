// Stroke icon set (24×24, lucide-style geometry) — inline to keep the
...
const PATHS = {
  ...
  qr: 'M3 3h7v7H3z M14 3h7v7h-7z M3 14h7v7H3z M14 14h3v3h-3z M18 18h3v3h-3z M14 20h2 M20 14v2 M6 6h1v1H6z M17 6h1v1h-1z M6 17h1v1H6z',
  scan: 'M3 7V5a2 2 0 0 1 2-2h2 M17 3h2a2 2 0 0 1 2 2v2 M21 17v2a2 2 0 0 1-2 2h-2 M7 21H5a2 2 0 0 1-2-2v-2 M7 12h10',
  send: 'M22 2L11 13 M22 2l-7 20-4-9-9-4z',
  receive: 'M12 3v12 M7 10l5 5 5-5 M5 21h14',
  request: 'M12 2v6 M9 5l3 3 3-3 M2 14h3l3.5 3H14a2 2 0 0 0 0-4h-3.5 M5 14v7 M14 17l5.2-2.6a2 2 0 0 1 2.6 2.9L17 21H5',
  ...
  eyeOff: 'M3 3l18 18 M10.6 5.1A10.9 10.9 0 0 1 12 5c6.5 0 10 7 10 7a18 18 0 0 1-3 3.9 M6.6 6.6A17.6 17.6 0 0 0 2 12s3.5 7 10 7a9.7 9.7 0 0 0 5.4-1.6 M9.9 9.9a3 3 0 0 0 4.2 4.2',
  ...
  clipboard: 'M9 2h6v4H9z M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2',
  ...
  bill: 'M4 2h16v20l-3-2-3 2-2-2-2 2-3-2-3 2z M8 7h8 M8 11h8 M8 15h5',
  transfer: 'M17 3l4 4-4 4 M3 7h18 M7 21l-4-4 4-4 M21 17H3',
